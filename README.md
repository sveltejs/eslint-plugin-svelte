...
| [svelte/no-checkbox-bind-value](https://sveltejs.github.io/eslint-plugin-svelte/rules/no-checkbox-bind-value/) | disallow useless `bind:value` on `<input type="checkbox">` | :star::wrench: |
