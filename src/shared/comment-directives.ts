...
export class CommentDirectives {
  ...
  public constructor(options: {
    ...
    this.reportUnusedDisableDirectives = Boolean(
  ...
  public filterMessages(messages: Linter.LintMessage[]): Linter.LintMessage[] {
    ...
    function isEnable(message: Linter.LintMessage) {
      ...
      for (const disableLines of getFromRule(
        lineDisableDirectives,
        message.ruleId,
      )) {
...
function getFromRule<E>(
  map: Map<string | typeof COMPUTED, E>,
  ruleId: string,
): E[] {
